...
/**
 * BookingModal component displays the details of a booking in a modal.
 * 
 * @component
 * @param {Object} props - The properties object.
 * @param {Object} props.booking - The booking details.
 * @param {Function} props.setModal - The function to close the modal.
 * @param {string} props.title - The title of the modal.
 * 
 * @returns {React.Element} The BookingModal component.
 */
const BookingModal = (props) => {
    ...
    /**
     * Navigates to the payment link for the booking.
     */
    const payLink = () => {
                    ...
                    <div style={{ flexBasis: '46%' }}>
                        <Text className="small">Rooms:
                            {booking.roomNumbers.map(r =>
                                (<span className="highlight" style={{ margin: '4px 2px' }} key={r}>{r}</span>)
                            )}
                        </Text>
