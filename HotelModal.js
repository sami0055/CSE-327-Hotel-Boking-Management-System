...
/**
 * HotelModal component for adding and updating hotel details.
 *
 * @component
 * @param {Object} props - The properties object.
 * @param {Object} props.hotel - The hotel details.
 * @param {Function} props.setHotelModal - Function to set the visibility of the hotel modal.
 * @param {string} props.title - The title of the modal.
 * @param {string} props.action - The action to be performed ('add' or 'update').
 *
 * @returns {React.Element} The HotelModal component.
 */
const HotelModal = (props) => {
    ...
    /**
     * Updates the current hotel details.
