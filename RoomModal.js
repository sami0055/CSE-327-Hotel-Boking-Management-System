...
/**
 * RoomModal component for adding or updating a hotel room.
 * 
 * @param {Object} props - Component properties.
 * @param {Object} props.room - Room details to be updated (if any).
 * @param {Object} props.hotel - Hotel details including ID and total rooms.
 * @param {Function} props.setRoomModal - Function to close the modal.
 * @param {string} props.title - Title of the modal (e.g., "Add Room", "Update Room").
 * @param {string} props.action - Action to be performed ("add" or "update").
...
const RoomModal = (props) => {
    ...
    /**
     * Adds a new field for image upload.
     */
    const addField = () => {
    ...
    /**
     * Handles the submission of the form to add a new room.
     * 
    ...
    /**
     * Handles the submission of the form to update an existing room.
     * 
     * @param {Event} e - Form submission event.
     */
    ...
    /**
     * Adds or removes a room number from the list of selected room numbers.
     * 
     * @param {number} n - Room number.
     * @param {boolean} assigned - Whether the room number is assigned or not.
     */
    ...
    /**
     * Changes the image at a specific index.
     * 
     * @param {Object} val - New image value.
     * @param {number} idx - Index of the image to be changed.
     */
